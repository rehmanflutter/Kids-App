              ...
              children: [
                ...
                const Center(
                  child: Text(
                    ...
                    style: TextStyle(fontSize: 18.0, color: darkblack),
                  ),
                ),
                ...
                GestureDetector(
                  onTap: () {
                    _launchURL(context, "https://github.com/rehmanflutter");
                  },
                  child: Row(
                    children: [
                      SvgPicture.asset(
                ...
                Row(
                  children: [
                    _buildIcon(context, 'https://github.com/rehmanflutter',
                        'assets/images/github.svg'),
                    const SizedBox(width: 16.0),
                    _buildIcon(context, 'rehmanflutter1@gmail.com',
                        'assets/images/email.svg'),
                    const SizedBox(width: 16.0),
                    GestureDetector(
                      onTap: () {
                        _launchURL(context,
                            'https://www.linkedin.com/in/rehmanflutter');
                      },
                    ...
                    _buildIcon(
                        context,
                        'https://www.instagram.com/rehmanflutter/',
